...
# C Compiler Flags
CFLAGS=`pkg-config --cflags irrBullet enet` 

# CC Compiler Flags
CCFLAGS=`pkg-config --cflags irrBullet enet` 
CXXFLAGS=`pkg-config --cflags irrBullet enet` 
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug_Linux_Server.mk dist/Debug_Linux_Server/GNU-Linux-x86/fightorflight

dist/Debug_Linux_Server/GNU-Linux-x86/fightorflight: ${OBJECTFILES}
	${MKDIR} -p dist/Debug_Linux_Server/GNU-Linux-x86
	${LINK.cc} `pkg-config --libs irrBullet enet` -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fightorflight  ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug_Linux_Server
	${RM} dist/Debug_Linux_Server/GNU-Linux-x86/fightorflight
